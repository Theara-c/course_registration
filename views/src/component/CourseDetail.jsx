      ...
      <div className="grid lg:grid-cols-2 gap-16">
        ...
        <div className="my-2">
          ...
          <p className=" text-black text-[20px]">
            Learn modern UI/UX design with real-world projects, design systems,
            and workflows used by top tech companies.
          </p>
          {/* additional info */}
          ...
          <p className="mt-7 text-black leading-10 text-[19px]">
            This course teaches you how to design beautiful interfaces and
            seamless user experiences from scratch. You will learn UX strategy,
            prototyping, wireframing and modern design workflows.
          </p>
        </div>
          ...
          <div className="bg-white rounded-2xl overflow-hidden shadow border w-8/10  ">
            ...
            <div className="p-5">
              ...
              <p className="text-black mt-3">
                Master modern design tools and principles to build beautiful
                products.
              </p>
